  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-16">
      ...
      <section className="mb-16">
        ...
        <p className="mt-2 text-xl font-medium text-slate-600 dark:text-slate-400">University of San Diego · 2024–2026</p>
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          <span className="font-medium text-slate-800 dark:text-slate-200">Alcalá 100 Honoree</span>.
        </p>
      </section>
      ...
      {featured.length > 0 && (
        <section className="mb-12">
          <h2 className="mb-4 text-lg font-bold text-slate-800 dark:text-slate-200">Capstone Project</h2>
      ...
      {/* All other projects */}
      <section>
        <h2 className="mb-4 text-lg font-semibold text-slate-700 dark:text-slate-300">Coursework Projects</h2>
