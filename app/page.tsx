        ...
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-col-reverse items-start gap-8 sm:flex-row sm:items-center">
            ...
            <img
              src="/dean.jpg"
              alt="Dean P. Simmer"
              className="h-36 w-36 rounded-full object-cover shadow-lg ring-4 ring-brand shrink-0"
            />
          </div>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border border-slate-600 px-5 py-2 text-sm font-semibold text-slate-200 hover:border-brand hover:text-brand transition-colors"
            >
              LinkedIn
            </a>
            <a
